...
describe('backendHistorySource', () => {
    ...
    describe('save', () => {
        it('всегда выбрасывает ошибку "Not implemented"', async () => {
            ...
            await expect(backendHistorySource.save(mockEntry))
                .rejects
    ...
    describe('remove', () => {
        it('всегда выбрасывает ошибку "Not implemented"', async () => {
            await expect(backendHistorySource.remove('test-id'))
                .rejects
                .toThrow('Not implemented');
        });
    });
    ...
    describe('clear', () => {
        it('всегда выбрасывает ошибку "Not implemented"', async () => {
            await expect(backendHistorySource.clear())
                .rejects
                .toThrow('Not implemented');
        });
    });
    ...
    describe('типизация', () => {
        ...
        it('методы возвращают промисы', async () => {
            ...
            const savePromise = backendHistorySource.save({} as HistoryEntry).catch(() => {});

...
vi.mock('@/shared/ui/Skeleton', () => ({ default: () => <div data-testid="skeleton" /> }));
...
describe('SignUpForm', () => {
    ...
    it('renders all three inputs', () => {
        ...
        expect(screen.getByPlaceholderText('Your password again')).toBeInTheDocument();
    });
    ...
    it('submits form with matching passwords', async () => {
        ...
        await userEvent.type(screen.getByPlaceholderText('Your password'), 'pass123');
        await userEvent.type(screen.getByPlaceholderText('Your password again'), 'pass123');
